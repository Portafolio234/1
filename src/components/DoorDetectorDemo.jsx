                ...
                <div className="flex-1 overflow-y-auto pr-2 space-y-6 custom-scrollbar">
                    ...
                    <div>
                        <h3 className="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider flex justify-between items-center">
                            Resultados <span className="text-[10px] bg-gray-700 px-2 py-0.5 rounded-full">{zones.length}</span>
                        </h3>
            ...
            <div ref={containerRef} className="flex-1 bg-[#0f172a] relative overflow-auto flex justify-center p-8">
                ...
                {!pdfDoc ? (
                    <div className="flex flex-col items-center justify-center h-full text-gray-500 opacity-50">
                        ...
                        {(generalError || pdfError) && <p className="text-red-500 mt-4 text-center font-bold">{generalError || pdfError}</p>}
                    </div>
                ) : (
                    <canvas
                        ref={canvasRef}
                        onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp}
                        className="shadow-2xl rounded-lg cursor-crosshair bg-white max-w-none"
                    />
                )}
            </div>
        </div>,
